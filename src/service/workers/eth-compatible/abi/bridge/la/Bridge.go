...
// UpdateExternalTx is a paid mutator transaction binding the contract method 0xb96bead1.
//
// Solidity: function updateExternalTx(bytes8 originChainID, bytes8 destinationChainID, uint64 depositNonce, bytes32 resourceID, address recipientAddress, uint256 amount, bytes params, uint8 status) returns()
func (_LaBr *LaBrTransactor) UpdateExternalTx(opts *bind.TransactOpts, originChainID [8]byte, destinationChainID [8]byte, depositNonce uint64, resourceID [32]byte, recipientAddress common.Address, amount *big.Int, params []byte, status uint8) (*types.Transaction, error) {
	return _LaBr.contract.Transact(opts, "updateExternalTx", originChainID, destinationChainID, depositNonce, resourceID, recipientAddress, amount, params, status)
}

// UpdateExternalTx is a paid mutator transaction binding the contract method 0xb96bead1.
//
// Solidity: function updateExternalTx(bytes8 originChainID, bytes8 destinationChainID, uint64 depositNonce, bytes32 resourceID, address recipientAddress, uint256 amount, bytes params, uint8 status) returns()
func (_LaBr *LaBrSession) UpdateExternalTx(originChainID [8]byte, destinationChainID [8]byte, depositNonce uint64, resourceID [32]byte, recipientAddress common.Address, amount *big.Int, params []byte, status uint8) (*types.Transaction, error) {
	return _LaBr.Contract.UpdateExternalTx(&_LaBr.TransactOpts, originChainID, destinationChainID, depositNonce, resourceID, recipientAddress, amount, params, status)
}

// UpdateExternalTx is a paid mutator transaction binding the contract method 0xb96bead1.
//
// Solidity: function updateExternalTx(bytes8 originChainID, bytes8 destinationChainID, uint64 depositNonce, bytes32 resourceID, address recipientAddress, uint256 amount, bytes params, uint8 status) returns()
func (_LaBr *LaBrTransactorSession) UpdateExternalTx(originChainID [8]byte, destinationChainID [8]byte, depositNonce uint64, resourceID [32]byte, recipientAddress common.Address, amount *big.Int, params []byte, status uint8) (*types.Transaction, error) {
	return _LaBr.Contract.UpdateExternalTx(&_LaBr.TransactOpts, originChainID, destinationChainID, depositNonce, resourceID, recipientAddress, amount, params, status)
}
