...
func main() {
	...
	posFetCfg, bscFetCfg, ethFetCfg, avaxFetCfg := cfg.ReadFetcherConfig()
	...
	app := app.NewApp(logger, srvURL, db, laCfg, posCfg, bscCfg, ethCfg, avaxCfg, posFetCfg, bscFetCfg, ethFetCfg, avaxFetCfg, resourceIDs)
